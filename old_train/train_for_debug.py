...
def main():
    ...
    #Folder where plot are saved for this run
    ...
    if args.mask and args.model=="cheng":
        ...
        torch.save(all_mask, "/home/ids/flauron-23/MagV/results/mask/mask/mask.pth")
    ...
    for epoch in range(last_epoch, args.epochs):
        ...
        if epoch%5==0:
            ...
            if args.mask and args.model == "cheng":
                ...
                file_path = os.path.join(data_dir, f"data_{args.nameRun}_{epoch}.json")
