...
def main():
    ...
    if args.mask and args.model=="msh":
    ...
    if args.mask and args.model == "msh":
        ...
        if args.mask and args.model == "msh":
            ...
            bpp_res["msh2018"] = ref_bpp_list
            psnr_res["msh2018"] = ref_psnr_list
            mssim_res["msh2018"] = ref_mssim_list
    ...
    for epoch in range(last_epoch, args.epochs):
        ...
        loss_tot_train, bpp_train, mse_train, aux_train_loss = train_one_epoch(
            ...
            args.clip_max_norm,
            args_mask=args.mask,
            all_mask=all_mask if args.mask and args.model=="msh" else None,
            lambda_list=lambda_list if args.mask and args.model=="msh" else None,
            parameters_to_prune=parameters_to_prune if args.mask and args.model=="msh" else None,
            probs=None
        )
